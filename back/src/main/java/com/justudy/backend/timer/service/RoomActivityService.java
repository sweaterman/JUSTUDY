...
public class RoomActivityService {
    ...
    public void deleteRoomActivity(Long studySequence) {
        ...
        StudyRoomEntity studyRoom = studyRoomRepository.getReferenceById(study.getStudyRoom().getSequence());
        List<RoomActivityEntity> roomActivityEntities = roomActivityRepository.findByStudyRoom(studyRoom.getSequence());
