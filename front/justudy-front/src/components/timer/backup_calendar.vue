    ...
    <v-app>
        ...
        <v-row :style="{marginTop: '2%'}" justify="center" align="center">
            ...
            <v-col cols="12" md="2" justify="center" align="center">
                <img src="@/assets/arrow.png" style="width: 25px; height: 25px; transform: rotate(0.5turn)" v-on:click="monthBefore()" />
            </v-col>
            <v-col cols="12" md="2" justify="center" align="center">
            ...
            <v-col cols="12" md="2" justify="center" align="center">
                <img src="@/assets/arrow.png" style="width: 25px; height: 25px" v-on:click="monthAfter()" />
            </v-col>
            <v-col cols="12" md="2" />
        </v-row>
                ...
                <v-row v-for="cr in Math.ceil((firstDayOfWeek + monthDate[month]) / 7)" :key="cr" class="d-flex justify-center">
                    <v-col v-for="cc in 7" v-bind:key="cc" id="td">
                        ...
                        <v-row :style="{marginTop: '15%', marginLeft: '15%'}">
                            <div style="font-size: 25px" v-if="7 * (cr - 1) + cc - firstDayOfWeek > 0 && 7 * (cr - 1) + cc - firstDayOfWeek <= monthDate[month]">고정 숫자</div>
                        </v-row>
                    </v-col>
                </v-row>
            </v-container>
