    ...
    <v-app>
        ...
        <v-row :style="{marginTop: '-8%'}">
            ...
            <v-col cols="12" md="8">
                <v-row>
                    <v-col cols="12" md="2">
                        <div align="left" :style="{fontSize: 'xx-large'}">스터디 관리</div>
                    </v-col>
                    ...
                    <v-simple-table style="width: 100%">
                        <thead>
                            <tr style="font-weight: bolder">
                                ...
                                <td style="width: 50%; font-size: x-large">스터디명</td>
                                <td style="width: 15%; font-size: x-large">스터디장</td>
                                <td style="width: 15%; font-size: x-large">스터디설명</td>
                                <td style="width: 10%; font-size: x-large">인원수</td>
                                <td style="width: 10%; font-size: x-large">개설일자</td>
                            </tr>
                        </thead>
                        <tbody>
