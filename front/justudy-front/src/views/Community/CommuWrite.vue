                ...
                <v-form ref="form" @submit.prevent="onSubmitForm">
                    <v-card>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="10">
                                <v-textarea v-model="context" label="내용" outlined rows="13" style="width: 80%; margin-right: 10%; margin-left: 5%; margintop: 4%"></v-textarea>
                            </v-col>
                        </v-row>
                    </v-card>
                </v-form>
        ...
        <v-row :style="{marginBottom: '10%'}">
            ...
            <v-col cols="12" md="8">
                <v-row>
                    ...
                    <v-col cols="12" md="2">
                        <v-btn @click="write" :style="{height: '50px', width: '90px', fontWeight: 'bold', fontSize: 'large'}">등록</v-btn>
                    </v-col>
                </v-row>
            </v-col>
            <v-col cols="12" md="2" />
