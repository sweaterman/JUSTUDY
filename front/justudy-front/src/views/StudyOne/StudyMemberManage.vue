                        ...
                        <div class="card_section_member">
                            <v-row justify="center" align="center">
                                <v-col cols="12" md="2" justify="center" align="center">
                                    <v-avatar size="50">
                                        <img
                                            :src="`${port}images/${member.imageSequence}`"
                                            alt="memberImg"
                                        />
                                    </v-avatar>
                                </v-col>
                                ...
                                <v-col cols="12" md="2">
                                    <v-btn
                                        @click="openDialog('giveLeader', member.sequence, 0)"
                                        color="white"
                                        depressed
                                    >
                                        <span
                                ...
                                <v-col cols="12" md="2">
                                    <v-btn
                                        @click="openDialog('withDraw', member.sequence, 0)"
                                        color="white"
                                        depressed
                                    >
                                        <span
                            ...
                            <v-row justify="center" align="center">
                                <v-col cols="12" md="2">
                                    <v-row>
                                        <v-avatar size="55">
                                            <img
                                                :src="`${port}images/${applicant.imageSequence}`"
                                                alt="memberImg"
                                            />
                                        </v-avatar>
                                    </v-row>
                                    <v-row :style="{marginTop: '20%'}">{{ applicant.nickName }}</v-row>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-row>{{ applicant.content }}</v-row>
                                </v-col>
                                <v-col cols="12" md="2">
                                    <v-btn
                                        @click="openDialog('accept', applicant.memberSeq, applicant.sequence)"
                                        color="white"
                                        depressed
                                    >
                                        <span
                                ...
                                <v-col cols="12" md="2">
                                    <v-btn
                                        @click="openDialog('reject', applicant.memberSeq, applicant.sequence)"
                                        color="white"
                                        depressed
                                    >
                                        <span
